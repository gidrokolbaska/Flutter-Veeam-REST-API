...
///
/// When open, the [CupertinoContextMenuNew] shows the child, or the widget returned
...
class CupertinoContextMenuNew extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [CupertinoContextMenuNew].
  ///
  /// When the [CupertinoContextMenuNew] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [CupertinoContextMenuNew] is "closed", this widget acts like a
  ...
  /// [CupertinoContextMenuNew] is open.
  ///
  ...
  @override
  State<CupertinoContextMenuNew> createState() =>
      _CupertinoContextMenuNewState();
}

class _CupertinoContextMenuNewState extends State<CupertinoContextMenuNew>
...
class _DecoyChildState extends State<_DecoyChild>
  ...
  static const Color _lightModeMaskColor = Color(0xFFEEEEEE);
